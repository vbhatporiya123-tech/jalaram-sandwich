...
function App() {
  ...
  const menuItems = [
    // Sandwich
    { id: 101, name: "Bread Butter", category: "Sandwich", price: "₹20", emoji: "🍞" },
    { id: 102, name: "Bread Butter Jam", category: "Sandwich", price: "₹30", emoji: "🍞🍓" },
    ...
    { id: 106, name: "Cheese Aloo Chaat", category: "Sandwich", price: "₹50", emoji: "🧀🥔" },
    { id: 107, name: "Veg. Mayonnaise Sadi Sandwich", category: "Sandwich", price: "₹50", emoji: "🥪" },
    { id: 108, name: "Veg. Double Decker Sadi Sandwich", category: "Sandwich", price: "₹60", emoji: "🥪" },
    ...
    { id: 111, name: "Bread Butter Cheese", category: "Sandwich", price: "₹50", emoji: "🍞🧀" },
    { id: 112, name: "Bread Butter Jam Cheese", category: "Sandwich", price: "₹60", emoji: "🍞🍓" },
    { id: 113, name: "Veg. Mayonnaise Cheese Sandwich", category: "Sandwich", price: "₹80", emoji: "🥪🧀" },
    { id: 114, name: "Veg. Double Decker Cheese Sandwich", category: "Sandwich", price: "₹90", emoji: "🥪🧀" },
    
    // Toast Sandwich
    { id: 201, name: "Bread Butter Toast", category: "Toast Sandwich", price: "₹30", emoji: "🍞🔥" },
    ...
    { id: 204, name: "Pizza Toast", category: "Toast Sandwich", price: "₹50", emoji: "🍕🍞" },
    { id: 205, name: "Veg. Cheese Toast Sandwich", category: "Toast Sandwich", price: "₹80", emoji: "🥪🧀" },
    { id: 206, name: "Masala Cheese Toast Sandwich", category: "Toast Sandwich", price: "₹80", emoji: "🥪🌶️" },
    { id: 207, name: "Cheese Chilli Toast Sandwich", category: "Toast Sandwich", price: "₹80", emoji: "🥪🌶️🧀" },
    { id: 208, name: "Only Cheese Toast Sandwich", category: "Toast Sandwich", price: "₹60", emoji: "🧀🔥" },
    { id: 209, name: "Open Cheese Toast Sandwich", category: "Toast Sandwich", price: "₹90", emoji: "🥪🧀" },
    { id: 210, name: "Club Sandwich", category: "Toast Sandwich", price: "₹80", emoji: "🥪✨" },
    { id: 211, name: "Tandoor Club Sandwich", category: "Toast Sandwich", price: "₹100", emoji: "🥪🔥" },
    { id: 212, name: "Pizza Cheese Toast", category: "Toast Sandwich", price: "₹80", emoji: "🍕🍞🧀" },
    { id: 213, name: "Wafer Toast", category: "Toast Sandwich", price: "₹90", emoji: "🥪🍟" },
    { id: 214, name: "Paneer Cheese Hevan", category: "Toast Sandwich", price: "₹120", emoji: "🥪🧀" },

    // Grill Sandwich
    { id: 301, name: "Veg. Cheese Grill Sandwich", category: "Grill Sandwich", price: "₹100", emoji: "🥪🔥" },
    { id: 302, name: "Veg. Cheese Jain Grill Sandwich", category: "Grill Sandwich", price: "₹100", emoji: "🥪🥦" },
    { id: 303, name: "Veg. Garlic Cheese Grill Sandwich", category: "Grill Sandwich", price: "₹130", emoji: "🥪🧄" },
    { id: 304, name: "Only Cheese Grill Sandwich", category: "Grill Sandwich", price: "₹100", emoji: "🧀🥪" },
    { id: 305, name: "Juice Grill Sandwich", category: "Grill Sandwich", price: "₹100", emoji: "🥪🥤" },
    { id: 306, name: "Paneer Cheese Grill", category: "Grill Sandwich", price: "₹130", emoji: "🥪🧀" },
    { id: 307, name: "Schezwan Grill Sandwich", category: "Grill Sandwich", price: "₹130", emoji: "🥪🌶️" },
    { id: 308, name: "Mayones Veg. Cheese Grill Sandwich", category: "Grill Sandwich", price: "₹110", emoji: "🥪🥗" },
    { id: 309, name: "Matka Grill Sandwich", category: "Grill Sandwich", price: "₹130", emoji: "🏺🥪" },
    { id: 310, name: "Paneer Matka Grill Sandwich", category: "Grill Sandwich", price: "₹150", emoji: "🏺🥪🧀" },

    // Rimzim
    { id: 401, name: "Rimzim", category: "Rimzim", price: "₹150", emoji: "🥪🌀" },
    { id: 402, name: "Paneer Rimzim", category: "Rimzim", price: "₹180", emoji: "🥪🧀" },
    { id: 403, name: "Heraferi", category: "Rimzim", price: "₹150", emoji: "🥪🎭" },
    { id: 404, name: "Golmal", category: "Rimzim", price: "₹320", emoji: "🥪🌀🧀" },
    { id: 405, name: "Basket pizza", category: "Rimzim", price: "₹150", emoji: "🧺🍕" },
    { id: 406, name: "Casata Roll", category: "Rimzim", price: "₹140", emoji: "🌀🍞" },
    ...
    // Pizza
    { id: 601, name: "Veg. Regular Cheese Pizza", category: "Pizza", price: "₹100", emoji: "🍕" },
    { id: 602, name: "Veg. Stuffed Cheese Pizza", category: "Pizza", price: "₹130", emoji: "🍕🧀" },
    { id: 603, name: "Veg. Mayones Cheese Pizza", category: "Pizza", price: "₹110", emoji: "🍕🥗" },
    { id: 604, name: "Veg. Paneer Cheese Pizza", category: "Pizza", price: "₹140", emoji: "🍕🧀" },
    { id: 605, name: "Veg. Paneer Mayones Cheese Pizza", category: "Pizza", price: "₹140", emoji: "🍕🥗🧀" },
    { id: 606, name: "Only Cheese Pizza", category: "Pizza", price: "₹100", emoji: "🍕🧀" },
    { id: 607, name: "Veg. Corn Pizza", category: "Pizza", price: "₹130", emoji: "🍕🌽" },
    { id: 608, name: "Garlic Cheese Pizza", category: "Pizza", price: "₹130", emoji: "🍕🧄" },
    { id: 609, name: "Schezwan Cheese Pizza", category: "Pizza", price: "₹130", emoji: "🍕🌶️" },
    { id: 610, name: "Veg. Paneer Corn Pizza", category: "Pizza", price: "₹150", emoji: "🍕🧀🌽" },
    { id: 611, name: "Italian Cheese Pizza", category: "Pizza", price: "₹130", emoji: "🍕🍅" },

    // Garlic Bread
    { id: 701, name: "Cheese Garlic Bread", category: "Garlic Bread", price: "₹80", emoji: "🥖🧄🧀" },
    { id: 702, name: "Schezwan Garlic Bread", category: "Garlic Bread", price: "₹90", emoji: "🥖🌶️" },
    { id: 703, name: "Veg. Garlic Bread", category: "Garlic Bread", price: "₹90", emoji: "🥖🥦" },
    { id: 704, name: "Onion Cheese Garlic Bread", category: "Garlic Bread", price: "₹90", emoji: "🥖🧅" },
    { id: 705, name: "Corn Garlic Bread", category: "Garlic Bread", price: "₹90", emoji: "🥖🌽" },
    { id: 706, name: "Matka Garlic Bread", category: "Garlic Bread", price: "₹80", emoji: "🏺🥖" },

    // Footlong
    { id: 801, name: "Cheese Footlong", category: "Footlong", price: "₹130", emoji: "🌭🧀" },
    { id: 802, name: "Cheese Paneer Footlong", category: "Footlong", price: "₹150", emoji: "🌭🧀" },
    { id: 803, name: "Cheese Mayones Footlong", category: "Footlong", price: "₹140", emoji: "🌭🥗" },
    { id: 804, name: "Tandoor Kulcha", category: "Footlong", price: "₹130", emoji: "🫓🔥" }
  ];
